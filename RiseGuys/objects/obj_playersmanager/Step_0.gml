...
playerNeck.image_xscale = sqrt(power(player1Head.phy_position_x-player2Head.phy_position_x,2)+power(player1Head.phy_position_y-player2Head.phy_position_y,2)) / 32;
